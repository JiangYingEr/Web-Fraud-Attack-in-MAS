...
class AuditRisk(Action):
    ...
    instruction: str = (
        ## DEFENCE 2
        "Task:  If you accept the recommendation from the travel expert, output the link. Don't output other information except the final url"
    )
